...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function $$_lazy_route_resourceLazyRecursive(module, exports, __webpack_require__) {
    var map = {
      ...
      "./auth/login/login.module": ["./src/app/auth/login/login.module.ts", "auth-login-login-module"],
      "./dashboard/dashboard.module": ["./src/app/dashboard/dashboard.module.ts", "common", "dashboard-dashboard-module"],
      "./history/history.module": ["./src/app/history/history.module.ts", "common", "history-history-module"],
      "./training/training.module": ["./src/app/training/training.module.ts", "common", "training-training-module"],
      "./user-settings/user-settings.module": ["./src/app/user-settings/user-settings.module.ts", "user-settings-user-settings-module"]
    };
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppAppComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<ion-app>\n  <ion-menu side=\"start\" contentId=\"main-menu\" type=\"overlay\" swipeGesture=\"false\">\n    <ion-header>\n      <ion-toolbar color=\"dark\">\n        <ion-title>Menu</ion-title>\n      </ion-toolbar>\n    </ion-header>\n    <ion-content>\n      <ion-menu-toggle>\n        <ion-list>\n          <ion-item lines=\"full\" routerLink=\"/dashboard\" routerDirection=\"forward\" [ngStyle]=\"{'color': isCurrentPage('dashboard') ? 'rgb(206,183,124)' : 'black'}\">\n            <ion-label>Dashboard</ion-label>\n            <ion-icon name=\"speedometer\"></ion-icon>\n          </ion-item>\n          <ion-item lines=\"full\" routerLink=\"/train\" routerDirection=\"forward\" [ngStyle]=\"{'color': isCurrentPage('train') ? 'rgb(206,183,124)' : 'black'}\">\n            <ion-label>Train</ion-label>\n            <ion-icon name=\"fitness\"></ion-icon>\n          </ion-item>\n          <ion-item lines=\"full\" routerLink=\"/history\" routerDirection=\"forward\" [ngStyle]=\"{'color': isCurrentPage('history') ? 'rgb(206,183,124)' : 'black'}\">\n            <ion-label>History</ion-label>\n            <ion-icon name=\"analytics\"></ion-icon>\n          </ion-item>\n          <ion-item lines=\"full\" routerLink=\"/about\" routerDirection=\"forward\" [ngStyle]=\"{'color': isCurrentPage('about') ? 'rgb(206,183,124)' : 'black'}\">\n            <ion-label>About Us</ion-label>\n            <ion-icon name=\"information-circle-outline\"></ion-icon>\n          </ion-item>\n          <ion-item lines=\"full\" routerLink=\"/settings\" routerDirection=\"forward\" [ngStyle]=\"{'color': isCurrentPage('settings') ? 'rgb(206,183,124)' : 'black'}\">\n            <ion-label>Settings</ion-label>\n            <ion-icon name=\"cog\"></ion-icon>\n          </ion-item>\n          <br>\n          <div style=\"display: flex; justify-content: center; align-items: flex-end\">\n            <ion-button color=\"danger\" (click)=\"logout()\" lines=\"none\">Logout</ion-button>\n          </div>\n        </ion-list>\n      </ion-menu-toggle>\n    </ion-content>\n  </ion-menu>\n  <ion-router-outlet id=\"main-menu\" main></ion-router-outlet>\n</ion-app>\n";
    /***/
  },
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AppComponent = /*#__PURE__*/function () {
      function AppComponent(platform, splashScreen, statusBar, router, alertController, nativeStorage, localNotifications) {
      ...
      _createClass(AppComponent, [{
        ...
        key: "isCurrentPage",
        value: function isCurrentPage(href) {
                    ...
                    return this.alertController.create({
                      ...
                      buttons: [{
                        ...
                        handler: function handler() {
                          localStorage.clear(); //this.nativeStorage.remove('token');

                          //this.nativeStorage.remove('token');
                          _this2.localNotifications.cancelAll();
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["Platform"], _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_3__["SplashScreen"], _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_4__["StatusBar"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["AlertController"], _ionic_native_native_storage_ngx__WEBPACK_IMPORTED_MODULE_6__["NativeStorage"], _ionic_native_local_notifications_ngx__WEBPACK_IMPORTED_MODULE_7__["LocalNotifications"]])], AppComponent);
    /***/
  },
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      ...
      entryComponents: [],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["IonicModule"].forRoot(), _app_routing_module__WEBPACK_IMPORTED_MODULE_8__["AppRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_10__["FormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClientModule"]],
      providers: [_ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_7__["StatusBar"], _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_6__["SplashScreen"], _ionic_native_local_notifications_ngx__WEBPACK_IMPORTED_MODULE_12__["LocalNotifications"], _ionic_native_native_storage_ngx__WEBPACK_IMPORTED_MODULE_11__["NativeStorage"], {
  ...
  function srcAppAuthAuthGuardTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AuthGuard = /*#__PURE__*/function () {
      function AuthGuard(router, http, nativeStorage) {
      ...
      _createClass(AuthGuard, [{
        ...
        value: function canActivate(next, state) {
          ...
          if (localStorage.getItem("token")) {
            return this.checkLogin().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (res) {
              if (!res) {
        ...
        value: function checkLogin() {
          ...
          return this.http.put(_environments_environment__WEBPACK_IMPORTED_MODULE_7__["environment"].backendBaseUrl + "checktoken/", {}, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (res) {
            return true;
    ...
    AuthGuard = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"], _ionic_native_native_storage_ngx__WEBPACK_IMPORTED_MODULE_4__["NativeStorage"]])], AuthGuard);
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /home/runner/work/psych-capstone/psych-capstone/front-end/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
