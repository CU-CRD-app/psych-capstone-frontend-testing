...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  /*! exports provided: GetProgressService */

  /***/
  function srcAppServiceGetProgressServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "GetProgressService", function () {
    ...
    var GetProgressService = /*#__PURE__*/function () {
      function GetProgressService(http, events) {
        _classCallCheck(this, GetProgressService);

        this.http = http;
        this.events = events;
      }

      _createClass(GetProgressService, [{
        key: "getData",
        value: function getData() {
          ...
          return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].backendBaseUrl + 'userData/', {}, httpOptions);
        }
      }]);
    ...
    GetProgressService.ctorParameters = function () {
      return [{
    ...
    GetProgressService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["Events"]])], GetProgressService);
    /***/
  }
}]);
