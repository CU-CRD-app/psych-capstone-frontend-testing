...
const routes = [
    { path: 'dashboard', canActivate: [_auth_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]], loadChildren: './dashboard/dashboard.module#DashboardPageModule' },
    { path: 'train', canActivate: [_auth_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]], loadChildren: './training/training.module#TrainingPageModule' },
    { path: 'history', canActivate: [_auth_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]], loadChildren: './history/history.module#HistoryPageModule' },
    { path: 'about', canActivate: [_auth_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]], loadChildren: './about-us/about-us.module#AboutUsPageModule' },
    { path: 'settings', canActivate: [_auth_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]], loadChildren: './user-settings/user-settings.module#UserSettingsPageModule' },
...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, router, alertController, nativeStorage, localNotifications) {
...
let AuthGuard = class AuthGuard {
    ...
    canActivate(next, state) {
        if (localStorage.getItem("token")) {
            return this.checkLogin().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(res => {
                if (!res) {
                    this.router.navigate(['/login']);
    ...
    checkLogin() {
        ...
        return this.http.put(_environments_environment__WEBPACK_IMPORTED_MODULE_7__["environment"].backendBaseUrl + "checktoken/", {}, httpOptions)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])((res) => true))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])((err) => Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["of"])(false)));
    }
};
...
AuthGuard = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"], _ionic_native_native_storage_ngx__WEBPACK_IMPORTED_MODULE_4__["NativeStorage"]])
], AuthGuard);
...
module.exports = __webpack_require__(/*! /home/runner/work/psych-capstone/psych-capstone/front-end/src/main.ts */"./src/main.ts");
